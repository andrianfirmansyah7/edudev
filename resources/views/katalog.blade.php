...
<body>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
          <div class="card d-flex justify-content-center">
            <img src="img/html.png" class="w-50 d-flex justify-content-center" alt="...">
            <div class="card-body">
              <h5 class="card-title-catalog">HTML</h5>
              <p class="card-text">Bahasa digunakan untuk membuat kerangka tampilan setiap situs web</p>
              <a href="#" class="btn btn-success btn-block">Akses Materi</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title-catalog">CSS</h5>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title-catalog">JavaScript</h5>
    ...
    <!-- <div id="katalog" class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
