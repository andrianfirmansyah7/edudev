        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end nav-pills" id="navbarNavAltMarkup">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn-outline-success" aria-current="page" href="login.html" target="_blank">Masuk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn-success" aria-current="page" href="register.html" target="_blank">Daftar</a>    
                    </li>
                </div>
            </div>
        </nav>
                    ...
                    <div class="card " style="box-shadow: -8px 12px 18px 0 rgb(25, 42, 70, 0.13); border-radius: 2px;">
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label" style="color: rgb(9, 48, 133);">Konfirmasi Email</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                ...
                                <p class="text-center" style="color: grey; font-size: small;">Sudah menjadi Anggota? <a href="login.html" style="color: black; font-size: small;"><b>Masuk</b></a></p>
                            </form>
